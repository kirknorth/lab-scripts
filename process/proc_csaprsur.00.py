...
# Define fields to exclude when writing CF/Radial file
IGNORE_FIELDS = [
    '{}_texture'.format(REFL_FIELD),
    '{}_texture'.format(ZDR_FIELD),
    '{}_texture'.format(PHIDP_FIELD),
    '{}_texture'.format(RHOHV_FIELD),
    '{}_texture'.format(NCP_FIELD),
    ]
...
def process_file(filename, outdir, verbose=False):
    ...
    # Step 2: Compute radar texture fields
...
def _parse_datastreams(filename, version='-9999'):
    ...
    datastream = 'sgpcsaprsur{}.00 : {} : {}'.format(FN, version, date)
